...
import com.platform.project.model.enums.InterfaceInfoStatusEnum;
...
public class InterfaceInfoController {
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody IdRequest idRequest,
        ...
        // 判断该接口是否可以调用
        com.platform.yuapiclientsdk.model.User user = new com.platform.yuapiclientsdk.model.User();
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        Gson gson = new Gson();
        com.platform.yuapiclientsdk.model.User user = gson.fromJson(userRequestParams, com.platform.yuapiclientsdk.model.User.class);
